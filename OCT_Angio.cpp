    ...
    : QMainWindow(parent)
{
    ...
    /*Mat img = imread("C:/Users/AMD-PC-08/Desktop/Red-eyes_08122021144803.png");
    imshow("Input", img);
    float invg = 1.0 / 5.0;
   
    for (int i = 0; i < 256; i++)
    {
        vector <int> arr1 = (i / 255.0) * invg * 255;
        arr.push_back(arr1);
    }
...
void OCT_Angio::intializeProcess()
{
    ...
    /*process->start("D:/Python_Projects/OCTA_Changed/build/exe.win-amd64-3.9/OCT_Angiography.exe", { dirData.absolutePath(),dirData.absolutePath() });
